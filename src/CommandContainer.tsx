  ...
  return (
    <div className="commandDropdown">
      ...
      <div className="commandNameContainer">
        <h3 className="nunito-semibold default-font commandName">{ commandName }</h3>
        <div className="commandDescContainer">
          <p className="nunito-normal default-font commandDesc">{"- " +  commandDesc }</p>
        </div>
      </div>
    </div>
  );
